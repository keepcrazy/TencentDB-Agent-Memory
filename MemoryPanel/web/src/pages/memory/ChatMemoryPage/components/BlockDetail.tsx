        ...
        return (
          <li key={it.id} className="_memory-detail-atomic-item">
            <AtomicHead
              ...
              canDeleteItem={!!canDelete && layer !== 'L3'}
              onEdit={onEdit}
...
export function BlockDetail({
  ...
  /** 仅资产 Owner 可逐条删除 L0/L1/L2；后端仍会再次校验。 */
  ...
  function renderDeleteButton(itemId?: string) {
    if (!canDeleteItems || !itemId) return null;
    return (
      <button
        type="button"
